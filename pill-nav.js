...
(function () {
  ...
  var DEFAULTS = {
    ...
    /* 配色（站点绿黑白） */
    green: '#2a6e3f',
    greenDim: 'rgba(42,110,63,.10)',
    greenBorder: 'rgba(42,110,63,.30)',
    dark: '#04150c',
    textColor: '#e9fff2',
  ...
  var CSS = [
    ...
    '  white-space:nowrap;cursor:pointer;box-shadow:0 0 18px rgba(42,110,63,.35);',
    '  transition:transform .25s cubic-bezier(.215,.61,.355,1),box-shadow .25s ease}',
    '.pnav-cta:hover{transform:translateY(-1px);box-shadow:0 4px 24px rgba(42,110,63,.5)}',
    '',
    '/* 当前屏指示：胶囊下方小圆点（发光绿） */',
    ...
    '  border-radius:50px;z-index:4;box-shadow:0 0 10px rgba(42,110,63,.8)}',
    '',
